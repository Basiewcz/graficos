...
function processarDados(dados) {
    ...
    incluirTexto(`Assim como observado mundialmente, as respostas obtidas em minha entrevista evidenciam a preferência das pessoas pelo <span>Instagram</span> em relação as outras redes.`)
}
